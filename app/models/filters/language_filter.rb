class LanguageFilter < Filter
  ...
  REMAINING_IDENTIFIER = %w(sqi amh aze ban ben bos bul zho 639 fin ell heb hin
                            ita kik kor hrv kur lav lit luo ltz mkd mul hbs 568
                            nor fas por rom ron srp som snk slo spa swa swe tgk
                            tam tel tha cze tir tuk 326 hun urd uzb vie bel wol
                            zza).freeze
